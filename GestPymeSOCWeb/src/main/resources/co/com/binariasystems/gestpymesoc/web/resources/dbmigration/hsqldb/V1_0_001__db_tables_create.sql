...
CREATE CACHED TABLE GPT_TIPOS_CONTRATO_LABORAL(
	ID_TIPO_CONTRATO INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
	COD_TIPO_CONTRATO VARCHAR(15) NOT NULL,
	NOMBRE VARCHAR(128) NOT NULL,
	DESCRIPCION VARCHAR(256),
	DURACION_DEFAULT_MESES INTEGER,
	APLICA_NOFICACION_TERMINACION VARCHAR(1),
	DIAS_NOTIFICACION_TERMINACION INTEGER,
	APLICA_PAGO_EXTRAS VARCHAR(1),
	ES_PRORROGABLE VARCHAR(1),
	TIEMPO_MINIMO_PRORROGA INTEGER,
	DURACION_MAXIMA INTEGER,
	APLICA_PERIODO_PRUEBA VARCHAR(1),
	ES_DURACION_FIJA VARCHAR(1),
	ES_PARA_INDEPENDIENTES VARCHAR(1),
	USUARIO_CREACION VARCHAR(30) NOT NULL,
	USUARIO_MODIFICACION VARCHAR(30),
	FEC_CREACION TIMESTAMP NOT NULL,
	FEC_MODIFICACION TIMESTAMP
...
CREATE CACHED TABLE GPT_BONIFICACIONES(
	ID_BONIFICACION INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
	ID_EMPRESA INTEGER NOT NULL,
	PERIODICIDAD VARCHAR(30) NOT NULL,
	MES_INICIAL DATE NOT NULL,
	MES_FINAL DATE NOT NULL,
	MODO_DISCRIMINACION VARCHAR(30) NOT NULL,
	VALOR NUMERIC(16,2)
);
