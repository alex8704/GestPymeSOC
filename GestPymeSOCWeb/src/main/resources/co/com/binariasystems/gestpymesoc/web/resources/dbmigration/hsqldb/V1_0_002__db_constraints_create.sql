...
ALTER TABLE GPT_CONTRATOS_LABORALES ADD CONSTRAINT CONTRAT_EMPLEADO_FK FOREIGN KEY (ID_EMPLEADO) REFERENCES MAT_TERCEROS (ID_TERCERO) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE GPT_REPORTE_TIEMPO ADD CONSTRAINT REPORTMP_EMPLEADO_FK FOREIGN KEY (ID_EMPLEADO) REFERENCES MAT_TERCEROS (ID_TERCERO) ON UPDATE NO ACTION ON DELETE NO ACTION;
