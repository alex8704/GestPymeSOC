...
import co.com.binariasystems.gestpymesoc.web.controller.thirdperson.AdmProviderViewController;
...
@View(url="/provider", viewStringsByConventions= true,
controller=AdmProviderViewController.class)
public class AdmProviderView extends AbstractView {
    ...
    private Pager<ProviderDTO, ProviderDTO> pager;
	
	private BeanFieldGroup<ProviderDTO> fieldGroup;
	...
	public Component build(){
	    ...
	    gridContainer = new GeneratedPropertyContainer(new BeanItemContainer<ProviderDTO>(ProviderDTO.class));
		thirdPersonGrid = new Grid();
		pager = new Pager<ProviderDTO, ProviderDTO>();
	...
	private class AdmProviderViewEventListener implements ValueChangeListener, ClickListener{
