...
- BaseProject-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- BaseProject-ui: main application module, development time
- BaseProject-production: module that produces a production mode WAR for deployment
