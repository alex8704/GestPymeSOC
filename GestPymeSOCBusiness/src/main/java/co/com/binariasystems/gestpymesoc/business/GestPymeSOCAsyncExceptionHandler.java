package co.com.binariasystems.gestpymesoc.business;
...
public class GestPymeSOCAsyncExceptionHandler implements AsyncUncaughtExceptionHandler {
	Logger LOGGER = LoggerFactory.getLogger(GestPymeSOCAsyncExceptionHandler.class);
	@Override
