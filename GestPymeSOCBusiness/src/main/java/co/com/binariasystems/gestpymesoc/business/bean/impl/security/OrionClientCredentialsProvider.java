...
public class OrionClientCredentialsProvider implements ClientCredentialsProvider {
	...
	public ClientCredentialsDTO getClientCredentials() {
		ConfigParameterDTO loginParam = paramBean.findByCodeAndApp(SystemConstants.ORION_RESTAPI_LOGIN_PARAM, Application.GESTPYMESOC);
		ConfigParameterDTO passwordParam = paramBean.findByCodeAndApp(SystemConstants.ORION_RESTAPI_PWD_PARAM, Application.GESTPYMESOC);
